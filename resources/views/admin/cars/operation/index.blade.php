        ...
        <div class="modal-dialog  modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <button onclick="delete_operation()" class="btn bg-danger text-white" data-dismiss="modal">حذف</button>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $(function() {
                ...
                operation_table = $('#operation-datatable').DataTable({
                    ...
                    ajax: "{{ route('admin.cars.operation.get') }}",
                    columns: [{
                            data: 'caroperationtypeid',
                            name: 'caroperationtypeid'
                        },
                        {
                            data: 'operationtype',
                            name: 'operationtype',
            ...
            $("#addform_man").submit(function(event) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('admin.cars.operation.create') }}",
            ...
            $("#editform_man").submit(function(event) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('admin.cars.operation.update') }}",
                    enctype: 'multipart/form-data',
                    processData: false,
                    contentType: false,
                    cache: false,
        ...
        function getDetails_operation($id) {
            var getURL = '{{ route('admin.cars.operation.getById', ['id' => 'man_id']) }}';
            ...
            $.ajax({
                ...
                success: function(data) {
                        ...
                        $('#id_edit').val(data.caroperationtypeid);
                        $('#name_edit').val(data.operationtype);
        ...
        function delete_operation() {
            ...
            $.ajax({
                type: 'post',
                url: "{{ route('admin.cars.operation.delete') }}",
                data: {
                    '_token': "{{ csrf_token() }}",
                    'id': id,
