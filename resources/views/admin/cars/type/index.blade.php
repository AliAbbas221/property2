...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $(function() {
                ...
                type_table = $('#type-datatable').DataTable({
                    ...
                    ajax: "{{ route('admin.cars.type.get') }}",
                    columns: [{
                            data: 'cartypeid',
                            name: 'cartypeid'
                        },
            ...
            $("#addform_man").submit(function(event) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('admin.cars.type.create') }}",
            ...
            $("#editform_man").submit(function(event) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('admin.cars.type.update') }}",
                    enctype: 'multipart/form-data',
                    processData: false,
                    contentType: false,
                    cache: false,
        ...
        function getDetails_type($id) {
            var getURL = '{{ route('admin.cars.type.getById', ['id' => 'man_id']) }}';
        ...
        function delete_type() {
            ...
            $.ajax({
                type: 'post',
                url: "{{ route('admin.cars.type.delete') }}",
                data: {
                    '_token': "{{ csrf_token() }}",
                    'id': id,
