...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $(function() {
                ...
                type_table = $('#type-datatable').DataTable({
                    ...
                    ajax: "{{ route('admin.items.type.get') }}",
                    columns: [{
                            data: 'useditemtypeid',
                            name: 'useditemtypeid'
                        },
            ...
            $("#addform_man").submit(function(event) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('admin.items.type.create') }}",
            ...
            $("#editform_man").submit(function(event) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('admin.items.type.update') }}",
                    enctype: 'multipart/form-data',
                    processData: false,
                    contentType: false,
                    cache: false,
        ...
        function getDetails_type($id) {
            var getURL = '{{ route('admin.items.type.getById', ['id' => 'man_id']) }}';
            ...
            $.ajax({
                ...
                success: function(data) {
                        ...
                        $('#id_edit').val(data.useditemtypeid);
                        $('#name_edit').val(data.usedtypename);
        ...
        function delete_type() {
            ...
            $.ajax({
                type: 'post',
                url: "{{ route('admin.items.type.delete') }}",
                data: {
                    '_token': "{{ csrf_token() }}",
                    'id': id,
