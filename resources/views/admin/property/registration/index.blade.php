                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <button type="button" href="#addModal" data-toggle="modal" class="btn btn-primary "
                                        style="    float: right;">
                                        نوع تسجيل جديد <i class="fa fa-plus "></i></button>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
        ...
        <div class="modal-dialog  modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header ">
                    ...
                    <h2 class="modal-title" id="addModalLabel">إضافة نوع جديد</h2>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $(function() {
                ...
                type_table = $('#type-datatable').DataTable({
                    ...
                    ajax: "{{ route('admin.property.registration.get') }}",
                    columns: [{
                            data: 'property_regestration_type_id',
                            name: 'property_regestration_type_id'
                        },
                        {
                            data: 'name',
                            name: 'name',
            ...
            $("#addform_man").submit(function(event) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('admin.property.registration.create') }}",
            ...
            $("#editform_man").submit(function(event) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('admin.property.registration.update') }}",
                    enctype: 'multipart/form-data',
                    processData: false,
                    contentType: false,
                    cache: false,
        ...
        function getDetails_type($id) {
            var getURL = '{{ route('admin.property.registration.getById', ['id' => 'man_id']) }}';
            ...
            $.ajax({
                ...
                success: function(data) {
                        ...
                        $('#id_edit').val(data.property_regestration_type_id);
        ...
        function delete_type() {
            ...
            $.ajax({
                type: 'post',
                url: "{{ route('admin.property.registration.delete') }}",
                data: {
                    '_token': "{{ csrf_token() }}",
                    'id': id,
