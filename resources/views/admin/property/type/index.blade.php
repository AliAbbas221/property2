                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <button type="button" href="#addModal" data-toggle="modal" class="btn btn-primary "
                                        style="    float: right;">
                                        نوع جديد <i class="fa fa-plus "></i></button>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $(function() {
                ...
                type_table = $('#type-datatable').DataTable({
                    ...
                    ajax: "{{ route('admin.property.type.get') }}",
                    columns: [{
            ...
            $("#addform_man").submit(function(event) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('admin.property.type.create') }}",
            ...
            $("#editform_man").submit(function(event) {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ route('admin.property.type.update') }}",
                    enctype: 'multipart/form-data',
                    processData: false,
                    contentType: false,
                    cache: false,
        ...
        function getDetails_type($id) {
            var getURL = '{{ route('admin.property.type.getById', ['id' => 'man_id']) }}';
            ...
            $.ajax({
                ...
                success: function(data) {
                        ...
                        $('#id_edit').val(data.property_type_id);
                        $('#name_edit').val(data.typename);
        ...
        function delete_type() {
            ...
            $.ajax({
                type: 'post',
                url: "{{ route('admin.property.type.delete') }}",
                data: {
                    '_token': "{{ csrf_token() }}",
                    'id': id,
